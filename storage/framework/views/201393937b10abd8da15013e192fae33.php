        ...
        <div class="w-full px-6 lg:px-8 py-8">
            ...
            <div class="relative w-full overflow-hidden rounded-3xl bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-700 p-8 shadow-xl mb-8">
                <div class="relative z-10 max-w-3xl">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="<?php echo e(route('generate-soal')); ?>"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
                    ...
                    <h2 class="text-4xl font-bold">
                        <?php echo e(number_format($totalQuestionSets)); ?>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
                    ...
                    <h2 class="text-4xl font-bold text-slate-900"><?php echo e($totalQuestions); ?></h2>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
                    ...
                    <h2 class="text-4xl font-bold text-slate-900"><?php echo e($aiGeneratedCount); ?></h2>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
                    ...
                    <h2 class="text-4xl font-bold text-slate-900">
                        <?php echo e($displayRemaining); ?>

                    </h2>
                    <p class="text-xs text-slate-400 mt-1">sisa dari <?php echo e($isUnlimited ? 'unlimited' : $limit); ?> generate</p>
                    <?php if(!$isUnlimited): ?>
                    <div class="mt-2 bg-slate-100 rounded-full h-1.5">
                        <div class="h-1.5 rounded-full <?php echo e($pct > 80 ? 'bg-red-400' : 'bg-amber-400'); ?>"
                             style="width: <?php echo e($pct); ?>%"></div>
                    </div>
                    <?php endif; ?>
                    <p class="text-xs text-slate-400 mt-1">
                        Paket: <?php echo e($plan?->name ?? 'Free'); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
                ...
                <div class="bg-blue-50 rounded-xl p-4 border border-blue-100">
                    ...
                    <p class="text-3xl font-bold text-blue-700"><?php echo e($totalMultipleChoice); ?></p>
                </div>

                <div class="bg-violet-50 rounded-xl p-4 border border-violet-100">
                    <p class="text-violet-600 text-sm font-medium">Essay</p>
                    <p class="text-3xl font-bold text-violet-700"><?php echo e($totalEssay); ?></p>
                </div>

                <div class="bg-green-50 rounded-xl p-4 border border-green-100">
                    <p class="text-green-600 text-sm font-medium">Mudah</p>
                    <p class="text-3xl font-bold text-green-700"><?php echo e($easyCount); ?></p>
                </div>

                <div class="bg-yellow-50 rounded-xl p-4 border border-yellow-100">
                    <p class="text-yellow-600 text-sm font-medium">Sedang</p>
                    <p class="text-3xl font-bold text-yellow-700"><?php echo e($mediumCount); ?></p>
                </div>

                <div class="bg-red-50 rounded-xl p-4 border border-red-100">
                    <p class="text-red-600 text-sm font-medium">Sulit</p>
                    <p class="text-3xl font-bold text-red-700"><?php echo e($hardCount); ?></p>
                </div>
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <div class="flex flex-wrap gap-2 mb-6">
                        <a href="<?php echo e(route('dashboard', ['period' => 'all'])); ?>"
                        class="px-4 py-2 rounded-xl text-sm font-medium
                        <?php echo e($period == 'all' ? 'bg-blue-600 text-white' : 'bg-white border'); ?>">
                            Semua Data
                        </a>

                        <a href="<?php echo e(route('dashboard', ['period' => '7days'])); ?>"
                        class="px-4 py-2 rounded-xl text-sm font-medium
                        <?php echo e($period == '7days' ? 'bg-blue-600 text-white' : 'bg-white border'); ?>">
                            7 Hari
                        </a>

                        <a href="<?php echo e(route('dashboard', ['period' => '30days'])); ?>"
                        class="px-4 py-2 rounded-xl text-sm font-medium
                        <?php echo e($period == '30days' ? 'bg-blue-600 text-white' : 'bg-white border'); ?>">
                            30 Hari
                        </a>

                        <a href="<?php echo e(route('dashboard', ['period' => 'year'])); ?>"
                        class="px-4 py-2 rounded-xl text-sm font-medium
                        <?php echo e($period == 'year' ? 'bg-blue-600 text-white' : 'bg-white border'); ?>">
                            Tahun Ini
                        </a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <div class="bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-2xl p-5 shadow">
                    ...
                    <h3 class="text-2xl font-bold mt-2">
                        <?php echo e($subjectStats->first()->subject ?? '-'); ?>
                ...
                <div class="bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-2xl p-5 shadow">
                    ...
                    <h3 class="text-2xl font-bold mt-2">
                        <?php if($mediumCount >= $easyCount && $mediumCount >= $hardCount): ?>
                            Sedang
                        <?php elseif($easyCount >= $hardCount): ?>
                            Mudah
                        <?php else: ?>
                            Sulit
                        <?php endif; ?>
            ...
            <div class="grid md:grid-cols-3 gap-4">
                ...
                <div>
                    <div class="flex justify-between mb-2">
                        ...
                        <span><?php echo e($aiGeneratedCount); ?></span>
                    </div>

                    <div class="w-full bg-slate-200 rounded-full h-3">
                        <div
                            class="bg-blue-600 h-3 rounded-full"
                            style="width: <?php echo e(($aiGeneratedCount / max($totalQuestionSets,1))*100); ?>%">
                        </div>
                    </div>
                </div>
           ...
           <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-8">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 p-6">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $topSubjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="w-full bg-slate-200 rounded-full h-3">
                                <div
                                    ...
                                    style="width: <?php echo e(($subject->total / max($topSubjects->max('total'),1)) * 100); ?>%">
                                </div>
                            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $latestQuestionSets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="flex flex-wrap justify-between items-center gap-4">
                            <div>
                                ...
                                <p class="text-slate-500">
                                    ...
                                    • <?php echo e(ucfirst($item['difficulty'])); ?>

                                </p>
                            </div>

                            <a href="<?php echo e(route('bank-soal.show', $item['id'])); ?>"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const subjectLabels = <?php echo json_encode($subjectStats->pluck('subject'), 15, 512) ?>;
    const subjectTotals = <?php echo json_encode($subjectStats->pluck('total'), 15, 512) ?>;
...
// Chart Provider AI //
const providerLabels = <?php echo json_encode($providerLabels, 15, 512) ?>;
const providerTotals = <?php echo json_encode($providerStats->pluck('total'), 15, 512) ?>;
...
if (difficultyCtx) {
    new Chart(difficultyCtx, {
        ...
        data: {
            ...
            datasets: [{
                data: [
                    <?php echo e($easyCount); ?>,
                    <?php echo e($mediumCount); ?>,
                    <?php echo e($hardCount); ?>
...
if (questionTypeCtx) {
    new Chart(questionTypeCtx, {
        ...
        data: {
            ...
            datasets: [{
                data: [
                    <?php echo e($totalMultipleChoice); ?>,
                    <?php echo e($totalEssay); ?>
...
<?php endif; ?><?php /**PATH C:\Magang Farkatech\edusoal-ai\resources\views/dashboard.blade.php ENDPATH**/ ?>